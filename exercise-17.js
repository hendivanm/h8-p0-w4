...
function totalDigitRekursif (angka) {
    var arrNum = ubahNumToStr (angka);
    if (arrNum.length === 1 ) { // BASE CASE
      return Number (arrNum);
    } else {
      var ubah = Number (arrNum.splice (0, 1));
      var hasil = arrNum.join ("");
      return (ubah) + totalDigitRekursif (hasil);
    }
}

function ubahNumToStr (num) {
